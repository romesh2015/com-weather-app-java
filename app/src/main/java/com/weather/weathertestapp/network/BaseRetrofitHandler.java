...
import static com.weather.weathertestapp.utilities.Config.BASE_URL;
public class BaseRetrofitHandler<T> {
    ...
    public void setupRetrofitAndOkHttp() {
        ...
        File httpCacheDirectory = new File(WeatherApp.getsAppContext().getCacheDir(), "offlineCache");

        //1 MB
        Cache cache = new Cache(httpCacheDirectory, 1 * 1024 * 1024);
